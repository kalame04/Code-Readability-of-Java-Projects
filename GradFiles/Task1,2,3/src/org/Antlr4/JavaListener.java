...
public interface JavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#callMethodStatement}.
	 * @param ctx the parse tree
	 */
	void enterCallMethodStatement(JavaParser.CallMethodStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#callMethodStatement}.
	 * @param ctx the parse tree
	 */
	void exitCallMethodStatement(JavaParser.CallMethodStatementContext ctx);
	/**
